...
collapse.Parent = MainHeader
collapse.BackgroundTransparency = 1.000
collapse.Position = UDim2.new(0.949999988, 0, 0.137999997, 0)
collapse.Size = UDim2.new(0, 21, 0, 21)
collapse.ZIndex = 2
collapse.Image = "rbxassetid://3926305904"
collapse.ImageRectOffset = Vector2.new(284, 4)
collapse.ImageRectSize = Vector2.new(24, 24)

-- เก็บสถานะว่าตอนนี้ UI ยุบหรือขยาย
